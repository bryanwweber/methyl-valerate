...
\begin{center}
    ...
    pressure traces by replacing \ce{O2} with \ce{N2} is also shown for reference.}
...
over the initial temperature. \Cref{fig:conv-comparison} compares the CONV simulations to the RCM
