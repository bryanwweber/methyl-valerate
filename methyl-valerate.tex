...
destroyed to form a particular fuel radical by all the reactions that can form that radical, and the
...
destroyed by \ce{H}-atom abstractions to form the fuel radicals shown. It can be seen that the two
...
condition as the other analysis is shown in \cref{tab:mv-radicals} in the ``RMG switch'' column.
